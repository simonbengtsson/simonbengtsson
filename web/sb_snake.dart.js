// Generated by dart2js, the Dart to JavaScript compiler version: 1.12.1.
...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _AsyncRun__initializeScheduleImmediate_closure: {
      "^": "Closure:8;_box_0,_captured_div_1,_captured_span_2",
    ...
    NoSuchMethodError_toString_closure: {
      "^": "Closure:14;_core$_box_0,_captured_sb_1",
  ...
  }], ["snakeapp", "sb_snake.dart",, O, {
    "^": "",
    main: [function() {
      $.canvasRect = document.querySelector("#canvas").getBoundingClientRect();
      $.score = 0;
      $.snake = O.Snake$();
      O.spawnApple();
      C.Window_methods.get$animationFrame(window).then$1(O.snakeapp__update$closure());
      var t1 = H.setRuntimeTypeInfo(new W._EventStream(window, "keydown", false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new O.KeyController().get$keyListener()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    }, "call$0", "snakeapp__main$closure", 0, 0, 1],
    spawnApple: function() {
      var t1 = O.Apple$();
      $.apple = t1;
      if ($.snake.intersects$1(0, t1.rect)) {
        J.remove$0$ax($.apple.box.elem);
        O.spawnApple();
      }
    },
    update: [function(delta) {
      var t1, moveRect, t2, isTooLeft, isTooRight, isTooTop, isTooBottom, t3;
      t1 = $.snake;
      moveRect = C.JSArray_methods.get$last(t1.segments).getMoveRect$1(t1.speed);
      t1 = moveRect.left;
      t2 = J.getInterceptor$n(t1);
      isTooLeft = t2.$le(t1, 0);
      isTooRight = J.$ge$n(t2.$add(t1, moveRect.width), J.get$width$x($.canvasRect));
      t1 = moveRect.top;
      t2 = J.getInterceptor$n(t1);
      isTooTop = t2.$le(t1, 0);
      isTooBottom = J.$ge$n(t2.$add(t1, moveRect.height), J.get$height$x($.canvasRect));
      if (isTooLeft || isTooRight || isTooTop || isTooBottom || O.isCannibal(moveRect)) {
        J.get$children$x(document.querySelector("#canvas")).clear$0(0);
        $.snake = O.Snake$();
        $.apple = O.Apple$();
        $.score = 0;
      } else {
        t1 = $.snake;
        t2 = C.JSArray_methods.get$last(t1.segments);
        t3 = J.getInterceptor$asx(t2);
        t3.set$length(t2, J.$add$ns(t3.get$length(t2), t1.speed));
        t2 = t1.growLength;
        if (t2 <= 0)
          if (J.$le$n(J.$sub$n(J.get$length$asx(C.JSArray_methods.get$first(t1.segments)), t1.speed), t1.thickness)) {
            J.remove$0$ax(C.JSArray_methods.get$first(t1.segments));
            t1 = t1.segments;
            ...
            t2 = C.JSArray_methods.get$first(t1.segments);
            t3 = J.getInterceptor$asx(t2);
            t3.set$length(t2, J.$sub$n(t3.get$length(t2), t1.speed));
          }
        else
          t1.growLength = t2 - t1.speed;
      }
      if ($.apple.rect.intersects$1(0, moveRect)) {
        J.remove$0$ax($.apple.box.elem);
        O.spawnApple();
        t1 = $.score;
        if (typeof t1 !== "number")
        ...
        document.querySelector("#score").textContent = "" + t1;
      }
      C.Window_methods.get$animationFrame(window).then$1(O.snakeapp__update$closure());
    }, "call$1", "snakeapp__update$closure", 2, 0, 16],
    isCannibal: function(moveRect) {
      var i, t1, t2;
      for (i = 0; t1 = $.snake.segments, t2 = t1.length, i < t2; ++i)
        if (i !== t2 - 2 && i !== t2 - 1)
          if (J.intersects$1$x(t1[i], moveRect))
            return true;
      return false;
    },
    Apple: {
      "^": "Object;box,rect",
      remove$0: function(_) {
        J.remove$0$ax(this.box.elem);
      },
      Apple$0: function() {
        var t1, t2, pos;
        t1 = J.toInt$0$n(J.get$width$x($.canvasRect));
        t2 = J.toInt$0$n(J.get$height$x($.canvasRect));
        pos = H.setRuntimeTypeInfo(new P.Point(C.C__JSRandom.nextInt$1(t1 - 50), C.C__JSRandom.nextInt$1(t2 - 50)), [null]);
        t2 = pos.x;
        t1 = pos.y;
        this.rect = P.Rectangle$(t2, t1, 50, 50, null);
        t1 = O.ElemBox$(document.querySelector("#canvas"), t2, t1, 50, 50);
        this.box = t1;
        J.get$classes$x(t1.elem).add$1(0, "apple");
      },
      static: {Apple$: function() {
          var t1 = new O.Apple(null, null);
          t1.Apple$0();
          return t1;
        }}
    },
    KeyController: {
      "^": "Object;",
      keyListener$1: [function(evt) {
        var t1, t2, t3, t4, pos, box;
        H.interceptedTypeCast(evt, "$isKeyboardEvent");
        t1 = evt.keyCode;
        if (typeof t1 !== "number")
          return t1.$ge();
        if (t1 >= 37 && t1 <= 40) {
          ...
          if (t3 < 0)
            return H.ioore(t1, t3);
          if (J.$lt$n(J.get$length$asx(t1[t3]), $.snake.thickness * 2)) {
            t1 = $.snake;
            t2 = t1.segments;
            t3 = t2.length;
            t4 = t3 - 1;
            ...
            J.set$length$asx(t2[t4], t1.thickness * 2 + 1);
          }
        }
        switch (evt.keyCode) {
          case 38:
            if (C.JSArray_methods.get$last($.snake.segments) instanceof O.RightSegment) {
              pos = C.JSArray_methods.get$last($.snake.segments).getNewLeftPos$0();
              box = O.ElemBox$(document.querySelector("#canvas"), pos.x, pos.y, 50, 50);
              t1 = $.snake.segments;
              J.get$classes$x(box.elem).add$1(0, "snake");
              t1.push(new O.UpSegment(box));
            } else if (C.JSArray_methods.get$last($.snake.segments) instanceof O.LeftSegment) {
              pos = C.JSArray_methods.get$last($.snake.segments).getNewRightPos$0();
              box = O.ElemBox$(document.querySelector("#canvas"), pos.x, pos.y, 50, 50);
              t1 = $.snake.segments;
              J.get$classes$x(box.elem).add$1(0, "snake");
              t1.push(new O.UpSegment(box));
            } else
              P.print("Not allowed direction");
            break;
          case 39:
            if (C.JSArray_methods.get$last($.snake.segments) instanceof O.UpSegment) {
              pos = C.JSArray_methods.get$last($.snake.segments).getNewRightPos$0();
              box = O.ElemBox$(document.querySelector("#canvas"), pos.x, pos.y, 50, 50);
              t1 = $.snake.segments;
              J.get$classes$x(box.elem).add$1(0, "snake");
              t1.push(new O.RightSegment(box));
            } else if (C.JSArray_methods.get$last($.snake.segments) instanceof O.DownSegment) {
              pos = C.JSArray_methods.get$last($.snake.segments).getNewLeftPos$0();
              box = O.ElemBox$(document.querySelector("#canvas"), pos.x, pos.y, 50, 50);
              t1 = $.snake.segments;
              J.get$classes$x(box.elem).add$1(0, "snake");
            ...
            break;
          case 40:
            if (C.JSArray_methods.get$last($.snake.segments) instanceof O.LeftSegment) {
              pos = C.JSArray_methods.get$last($.snake.segments).getNewLeftPos$0();
              box = O.ElemBox$(document.querySelector("#canvas"), pos.x, pos.y, 50, 50);
              t1 = $.snake.segments;
              J.get$classes$x(box.elem).add$1(0, "snake");
              t1.push(new O.DownSegment(box));
            } else if (C.JSArray_methods.get$last($.snake.segments) instanceof O.RightSegment) {
              pos = C.JSArray_methods.get$last($.snake.segments).getNewRightPos$0();
              box = O.ElemBox$(document.querySelector("#canvas"), pos.x, pos.y, 50, 50);
              t1 = $.snake.segments;
              J.get$classes$x(box.elem).add$1(0, "snake");
    ...
    Segment: {
      ...
      intersects$1: function(_, other) {
        var t1, t2, t3, t4, t5;
        t1 = this._box;
        t2 = t1.elem.style.left;
        H.checkString("");
        t2 = H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null);
        t3 = other.left;
        t4 = J.getInterceptor$ns(t3);
        if (J.$le$n(t2, t4.$add(t3, other.width))) {
          t2 = t1.elem.style.left;
          H.checkString("");
          t2 = H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null);
          t5 = t1.elem.style.width;
          H.checkString("");
          if (t4.$le(t3, J.$add$ns(t2, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t5, "px", ""), null, null)))) {
            t2 = t1.elem.style.top;
            H.checkString("");
            t2 = H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null);
            t3 = other.top;
            t4 = J.getInterceptor$ns(t3);
            if (J.$le$n(t2, t4.$add(t3, other.height))) {
              t2 = t1.elem.style.top;
              H.checkString("");
              t2 = H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null);
              t1 = t1.elem.style.height;
              H.checkString("");
              t1 = t4.$le(t3, J.$add$ns(t2, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null)));
            } else
              t1 = false;
          } else
            t1 = false;
      ...
      remove$0: function(_) {
        J.remove$0$ax(this._box.elem);
      },
      toString$0: function(_) {
        return this._box.toString$0(0);
      }
    },
    RightSegment: {
      "^": "Segment;_box",
      getMoveRect$1: function(speed) {
        var t1, t2, t3;
        t1 = this._box;
        t2 = t1.elem.style.left;
        H.checkString("");
        t2 = H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null);
        t3 = t1.elem.style.width;
        H.checkString("");
        ...
        t1 = t1.elem.style.height;
        H.checkString("");
        return P.Rectangle$(t3, t2, speed, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null), null);
      },
      getNewRightPos$0: function() {
        var t1, t2, t3, x;
        t1 = this._box;
        t2 = t1.elem.style.left;
        H.checkString("");
        ...
        H.checkString("");
        t3 = J.$add$ns(t2, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t3, "px", ""), null, null));
        t2 = t1.elem.style.height;
        H.checkString("");
        x = J.$sub$n(t3, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null));
        t1 = t1.elem.style.top;
        H.checkString("");
        return H.setRuntimeTypeInfo(new P.Point(x, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null)), [null]);
      },
      getNewLeftPos$0: function() {
        var t1, t2, t3, x;
        t1 = this._box;
        t2 = t1.elem.style.left;
        H.checkString("");
      ...
      get$length: function(_) {
        var t1 = this._box.elem.style.width;
        H.checkString("");
        return H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null);
      },
      set$length: function(_, newLength) {
        var t1, t2, t3, t4;
        t1 = this._box;
        t2 = t1.elem.style.width;
        H.checkString("");
        t3 = J.getInterceptor$n(newLength);
        t2 = t3.$gt(newLength, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null));
        t4 = t1.elem;
        if (t2) {
          t2 = t4.style.width;
          H.checkString("");
          t2 = t3.$sub(newLength, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null));
          t3 = t1.elem.style.width;
          H.checkString("");
          t2 = J.$add$ns(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t3, "px", ""), null, null), t2);
          t1 = t1.elem.style;
          t2 = "" + J.toInt$0$n(t2) + ".px";
          t1.width = t2;
        } else {
          t2 = t4.style.width;
          H.checkString("");
          t2 = J.$sub$n(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null), newLength);
          t3 = t1.elem.style.width;
          H.checkString("");
          t3 = J.$sub$n(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t3, "px", ""), null, null), t2);
          t4 = t1.elem.style;
          t3 = "" + J.toInt$0$n(t3) + ".px";
          t4.width = t3;
          t3 = t1.elem.style.left;
          H.checkString("");
          t2 = J.$add$ns(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t3, "px", ""), null, null), t2);
          t1 = t1.elem.style;
          t2 = H.S(t2) + ".px";
    ...
    UpSegment: {
      ...
      getMoveRect$1: function(speed) {
        ...
        H.checkString("");
        t2 = H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null);
        t3 = t1.elem.style.top;
        H.checkString("");
        t3 = J.$sub$n(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t3, "px", ""), null, null), speed);
        t1 = t1.elem.style.width;
        H.checkString("");
        return P.Rectangle$(t2, t3, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null), speed, null);
      },
      getNewRightPos$0: function() {
        var t1, t2;
        t1 = this._box;
        ...
        t1 = t1.elem.style.top;
        H.checkString("");
        return H.setRuntimeTypeInfo(new P.Point(t2, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null)), [null]);
      },
      getNewLeftPos$0: function() {
        var t1, t2, x;
        t1 = this._box;
        t2 = t1.elem.style.left;
        H.checkString("");
        x = H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null);
        t1 = t1.elem.style.top;
        H.checkString("");
        return H.setRuntimeTypeInfo(new P.Point(x, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null)), [null]);
      },
      get$length: function(_) {
        var t1 = this._box.elem.style.height;
        H.checkString("");
        return H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null);
      },
      set$length: function(_, newLength) {
        ...
        if (t2) {
          ...
          t3 = t1.elem.style.height;
          H.checkString("");
          t2 = J.$sub$n(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t3, "px", ""), null, null), t2);
          t1 = t1.elem.style;
          t2 = "" + J.toInt$0$n(t2) + ".px";
          t1.height = t2;
        }
    ...
    DownSegment: {
      ...
      getMoveRect$1: function(speed) {
        ...
        t3 = t1.elem.style.top;
        H.checkString("");
        t3 = H.Primitives_parseInt(H.stringReplaceAllUnchecked(t3, "px", ""), null, null);
        t4 = t1.elem.style.height;
        H.checkString("");
        t4 = J.$add$ns(t3, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t4, "px", ""), null, null));
        t1 = t1.elem.style.width;
        H.checkString("");
        return P.Rectangle$(t2, t4, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null), speed, null);
      },
      getNewRightPos$0: function() {
        var t1, t2, x, t3;
        t1 = this._box;
        ...
        t1 = t1.elem.style.width;
        H.checkString("");
        return H.setRuntimeTypeInfo(new P.Point(x, J.$sub$n(t3, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null))), [null]);
      },
      getNewLeftPos$0: function() {
        var t1, t2, x, t3;
        t1 = this._box;
      ...
      set$length: function(_, newLength) {
        ...
        if (t2) {
          ...
          t3 = t1.elem.style.top;
          H.checkString("");
          t3 = J.$add$ns(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t3, "px", ""), null, null), t2);
          t4 = t1.elem.style;
          t3 = H.S(t3) + ".px";
          t4.top = t3;
          t3 = t1.elem.style.height;
    ...
    LeftSegment: {
      ...
      getMoveRect$1: function(speed) {
        ...
        t2 = t1.elem.style.left;
        H.checkString("");
        t2 = J.$sub$n(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null), speed);
        t3 = t1.elem.style.top;
        H.checkString("");
        t3 = H.Primitives_parseInt(H.stringReplaceAllUnchecked(t3, "px", ""), null, null);
        t1 = t1.elem.style.height;
        H.checkString("");
        return P.Rectangle$(t2, t3, speed, H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null), null);
      },
      getNewRightPos$0: function() {
        var t1, t2, x;
        t1 = this._box;
    ...
    Snake: {
      "^": "Object;segments,speed,thickness,growLength",
      intersects$1: function(_, other) {
        var i, t1;
        for (i = 0; t1 = this.segments, i < t1.length; ++i)
          if (J.intersects$1$x(t1[i], other))
            return true;
        return false;
      },
      Snake$0: function() {
        ...
        this.segments = [];
        this.growLength = 400;
        t1 = J.get$height$x($.canvasRect);
        if (typeof t1 !== "number")
          return t1.$div();
        t2 = this.thickness;
        box = O.ElemBox$(document.querySelector("#canvas"), 0, C.JSDouble_methods.toInt$0(t1 / 2 - t2 / 2), 1, 50);
        t2 = this.segments;
        J.get$classes$x(box.elem).add$1(0, "snake");
        t2.push(new O.RightSegment(box));
      },
      static: {Snake$: function() {
          var t1 = new O.Snake(null, null, null, null);
          t1.Snake$0();
          return t1;
        }}
    },
    ElemBox: {
      "^": "Object;elem",
      get$x: function(_) {
        var t1 = this.elem.style.left;
        H.checkString("");
        return H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null);
      },
      get$y: function(_) {
        var t1 = this.elem.style.top;
        H.checkString("");
        return H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null);
      },
      toString$0: function(_) {
        var t1, t2;
        t1 = this.elem.style.left;
        H.checkString("");
        t1 = "X: " + H.S(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null)) + " Y: ";
        t2 = this.elem.style.top;
        H.checkString("");
        t2 = t1 + H.S(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null)) + " Width: ";
        t1 = this.elem.style.width;
        H.checkString("");
        t1 = t2 + H.S(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t1, "px", ""), null, null)) + " Height: ";
        t2 = this.elem.style.height;
        H.checkString("");
        return t1 + H.S(H.Primitives_parseInt(H.stringReplaceAllUnchecked(t2, "px", ""), null, null));
      },
      ElemBox$5: function($parent, x, y, width, height) {
        var t1, t2;
        this.elem = document.createElement("div", null);
        J.get$children$x($parent).add$1(0, this.elem);
        t1 = this.elem.style;
        t2 = H.S(x) + ".px";
        t1.left = t2;
        t1 = this.elem.style;
        ...
        t1.top = t2;
        t1 = this.elem.style;
        t2 = "" + C.JSInt_methods.toInt$0(width) + ".px";
        t1.width = t2;
        t1 = this.elem.style;
        t2 = "" + C.JSInt_methods.toInt$0(height) + ".px";
        t1.height = t2;
      },
      static: {ElemBox$: function($parent, x, y, width, height) {
          var t1 = new O.ElemBox(null);
          t1.ElemBox$5($parent, x, y, width, height);
          return t1;
        }}
    }
  }, 1]];
...
;
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, void: true}, {func: 1, args: [,]}, {func: 1, void: true, args: [{func: 1, void: true}]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, void: true}]}, {func: 1, void: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.bool}, {func: 1, args: [, P.StackTrace]}, {func: 1, void: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [P.Symbol,,]}, {func: 1, void: true, args: [W.Event]}, {func: 1, void: true, args: [P.num]}];
  ...
  (function(callback) {
    ...
    if (typeof dartMainRunner === "function")
      dartMainRunner(function(a) {
        H.startRootIsolate(O.snakeapp__main$closure(), a);
      }, []);
    else
      (function(a) {
        H.startRootIsolate(O.snakeapp__main$closure(), a);
...
//# sourceMappingURL=sb_snake.dart.js.map
